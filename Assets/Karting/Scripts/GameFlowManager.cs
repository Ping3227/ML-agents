...
public class GameFlowManager : MonoBehaviour
{
    ...
    [Header("AI Objective")]
    public AiObjective aiObjective;
    public DisplayMessage loseToAI;
    ...
    void Start()
    {
        ...
        loseToAI.gameObject.SetActive(false);
    ...
    void EndGame(bool win)
    {
        ...
        else
        {
            ...
            if (aiObjective.finished)
            {
                loseToAI.delayBeforeShowing = delayBeforeWinMessage;
                loseToAI.gameObject.SetActive(true);
            }
            else {
