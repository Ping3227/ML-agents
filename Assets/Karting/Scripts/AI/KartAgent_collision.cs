...
namespace KartGame.AI
{
    ...
    /// </summary>
    public class KartAgent_Collision : Agent, IInput
    {
...
#region Senses
        ...
        [Tooltip("what is the other kart")]
...
#region Debugging
        ...
        public override void CollectObservations(VectorSensor sensor)
        {
            ...
            for (var i = 0; i < Sensors.Length; i++)
            {
                ...
                hit = Physics.Raycast(AgentSensorTransform.position, xform.forward, out hitInfo,
                    current.RayDistance, KartMask, QueryTriggerInteraction.Ignore);
                // closer than others kart 
                sensor.AddObservation(hit ? hitInfo.distance : current.RayDistance);
